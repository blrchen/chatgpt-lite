...
//     // For local development / testing: return a hardcoded response stream
//     // instead of calling the OpenAI API.
//     const encoder = new TextEncoder()
//     const stream = new ReadableStream({
//       start(controller) {
//         // Always return the exact test message for development/testing.
//         const message = 'this is a test'
//         // reference messagesWithHistory so it doesn't become an unused variable
//         void messagesWithHistory
