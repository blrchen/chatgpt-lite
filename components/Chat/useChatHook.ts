...
const systemPrompt = `${prompts.objective} ${prompts.genericInsights} ${prompts.dimension1}`
...
export const DefaultPersonas: Persona[] = [
  {
    ...
    role: 'system',
    name: 'Dimension 1',
    prompt: `${prompts.objective} ${prompts.genericInsights} ${prompts.dimension1}`,
    isDefault: true
  },
  {
    id: 'dimension2',
    role: 'system',
    name: 'Dimension 2',
    prompt: `${prompts.objective} ${prompts.genericInsights} ${prompts.dimension2}`,
    isDefault: false
  },
  {
    id: 'dimension3',
    role: 'system',
    name: 'Dimension 3',
    prompt: `${prompts.objective} ${prompts.genericInsights} ${prompts.dimension3}`,
    isDefault: false
  },
  {
    id: 'dimension4',
    role: 'system',
    name: 'Dimension 4',
    prompt: `${prompts.objective} ${prompts.genericInsights} ${prompts.dimension4}`,
    isDefault: false
  },
]
